...
class PlanConstructionPrompt:
    ...
    1: Florence2 for general object detection.
    ...
    4: Florence2 for specific object detection.
    ...
    5: Qwen2 for open-ended chat with images.
    ...
    Plan: "Call Qwen2 with the question 'Does this image contain brown dogs? If so, what are they doing?'. Then call Florence2 in object specific mode with the input phrase 'brown dog'."

    User question: "Find all the objects in this image and extract any text."
    Plan: "Call Florence2 in object general mode to get all objects. Then call Florence2 in OCR mode to get the texts."

    User question: "What's going on in this image? If monkeys are present, show me where they are."
    Plan: "Call Qwen2 with the question 'What's happening in this image? Are monkeys present?'. Then call Florence2 in object specific mode with the phrase 'monkey'."

    User question: "Show me the robins in this photo."
    Plan: "Call Florence2 in object specific mode with the phrase 'robin'."
